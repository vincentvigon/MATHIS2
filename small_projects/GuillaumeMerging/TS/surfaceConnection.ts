...
module mathis {
    ...
    export module surfaceConnection {
        ...
        export class SurfaceConnectionProcess {
            ...
            /** ******************************************* **/
            normalsComputation(): HashMap<Vertex,XYZ> {
            ...
            /** ************************************* **/
            aligningNormals(vertexToNormal: HashMap<Vertex,XYZ>)
            {
            ...
            /** ************************************** **/
            alreadyFilledSurfacesDetection(vertexToNormal: HashMap<Vertex,XYZ>) : StringMap<boolean>
            {
            ...
            /** ********************** **/
            floatedLinksSuppression(tablinkdelete:Array<Array<Vertex>>, tab_polys: Array<Array<Vertex>>)
            {
            ...
            /** ************************************************************************** **/
            polygonsDetection(vertexToNormal: HashMap<Vertex,XYZ>, alreadyTravel: StringMap<boolean> ) : Array<Array<Vertex>>
            {
                let tablinkdelete = [];
                let tab_polys = [];
            ...
            /** ******************************************************************** **/
            areaAndPerimeterComputation(tab_polys: Array<Array<Vertex>>) : Array<Vertex>
            {
                let tabSurface = [];
            ...
            /** ****************************************** **/
            fillConvexSurface(polygon: Array<Vertex>, centerVertex:Vertex)
            {
            ...
            /** ********************************* **/
            fillNoConvexSurface(polygon: Array<Vertex>, vertexToNormal: HashMap<Vertex,XYZ>) {
            ...
            go(): Mamesh {
                ...
                let alreadyTravel = this.alreadyFilledSurfacesDetection(vertexToNormal);
                ...
                for (let p of tab_polys)
                {
                    ...
                    else if (p.length >= 5)
                    {
                        ...
                        if (this.fillConvexFaces)
                        {
                            ...
                            this.fillNoConvexSurface (p, vertexToNormal);
                        }
                    }
                }
