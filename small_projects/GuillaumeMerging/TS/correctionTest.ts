...
module mathis{
        ...
        import Choices = mathis.appli.Choices;
    export class ConnectorPiece implements appli.PieceOfCode{
            ...
            connect=false;
            $$$connect=new Choices([true,false],{type:appli.ChoicesOptionsType.button,visualValues:['T','F'],containerName:'N'});
            ...
            surfaceChoice=1;
            $$$surfaceChoice=new Choices([1,2,3,4,5,6,7],{visualValues:['Flat','Strange flat','Filled flat','Half-cylinder','Moebius','Grat&glue 1','Grat&glue 2']});

            areaOrPerimeterChoice=true;
            $$$areaOrPerimeterChoice=new Choices([true,false],{visualValues:['true','false']});

            fillConvexFaces=true;
            $$$fillConvexFaces=new Choices([true,false],{visualValues:['true','false']});
