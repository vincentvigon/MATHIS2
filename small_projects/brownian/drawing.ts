///<reference path="../lib/MATHIS.d.ts"/>
/**
...
module tests {
    ...
    import SquareSubdivider = mathis.mameshModification.SquareSubdivider;
    ...
    function drawingBrownian() {
        ...
        surfaceViewer.normalDuplication = NormalDuplication.none;
    ...
    if(!online) {
        let field = genBrownian(size,r,h);
