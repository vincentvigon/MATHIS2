    ...
    function testRiemann(mathisFrame) {
        ...
        }
        {
            var test = function (neighborhoodCoeficients) {
                ...
                new mathis.spacialTransformations.Similitude(mamesh1.vertices, 0, new mathis.XYZ(0.3, 0.2, 0)).goChanging();
                new mathis.spacialTransformations.Similitude(mamesh2.vertices, 0, new mathis.XYZ(0.2, -0.2, 0)).goChanging();
        ...
        }
        {
            ...
            new mathis.spacialTransformations.Similitude(mamesh1.vertices, Math.PI / 4, new mathis.XYZ(0, 0, 0), new mathis.XYZ(0.5, 0.5, 0)).goChanging();
            var grater = new mathis.grateAndGlue.GraphGrater();
