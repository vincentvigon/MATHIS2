...
//
//
//             //keepOnlyVerticesOnFacesVersusOnHexahedronVersusAll=0
//
...
//
//
//                 // if (this.keepOnlyVerticesOnFacesVersusOnHexahedronVersusAll==0){
//                 //
...
//                 //     }
//                 //     this.mamesh.vertices=dico.allKeys()
//                 // }
//                 // else if (this.keepOnlyVerticesOnFacesVersusOnHexahedronVersusAll==1){
//                 //     let dico=new HashMap<Vertex,boolean>(true)
//                 //     for (let v of this.mamesh.hexahedrons){
//                 //         if (dico.getValue(v)==null) dico.putValue(v,true)
//                 //     }
//                 //     this.mamesh.vertices=dico.allKeys()
//                 // }
...
//                 if(this.suppressVolumes == null) this.suppressVolumes = [];
//
//                 let dico=new StringMap<boolean>()
//                 for (let coor of this.suppressVolumes) dico.putValue(coor[0]+','+coor[1]+','+coor[2],true)
//
//
//                 let n = this.subdivider;
//                 for(let i = 0;i < n;i++) {
...
//                             //     }))
//                             if (dico.getValue(i+','+j+','+k)!=null) continue
//
