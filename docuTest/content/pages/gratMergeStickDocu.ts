    ...
    export module appli {
        ...
        export class GrateMergeStick implements OnePage {
            ...
            constructor(private mathisFrame: MathisFrame) {
                ...
                several.addComment("Next we detail some class used internally in previous processes.", "Grating and gluing details")
        ...
        class FindPolygonsFromLinks implements PieceOfCode {
            ...
            surfaceChoice = 'ultra simple'
            $$$surfaceChoice = ['ultra simple','ultra simple with triangle','a five side poly','impasse','alreadyOneQuad','Flat', 'Strange flat', 'Filled flat', 'Half-cylinder', 'Moebius', 'Grat&glue 1', 'Grat&glue 2', 'nothingToDo', 'bugged']
