...
module mathis {
    ...
    export module gauss {
        ...
        class DrawNormalAndTangentVector{
            ...
            drawTangentPlanes(u:number,v:number,carte:riemann.Carte,clickOnPlaneNow:boolean,meshesToDispose:AbstractMesh[]):void{
        ...
        class GaussCurvature{
            ...
            private surfaceCamera:GrabberCamera
            private sphereCamera:GrabberCamera
            private surfaceScene:BABYLON.Scene
            private sphereScene:BABYLON.Scene
            private surfaceMathisFrame:MathisFrame

            private meshesToDispose:AbstractMesh[]=[]
                    ...
                    /**point de vue*/
                    {
                        ...
                        this.$pointOfVue.onchange=(ev)=>{
                            if (this.$pointOfVue.selectedIndex>0){
                                ...
                                // this.surfaceMathisFrameCamera.changePosition(position,false)
                                // this.surfaceMathisFrameCamera.changeUpVector(new XYZ(0,1,0),false)
                                // this.surfaceMathisFrameCamera.changeFrontDir(XYZ.newFrom(position).scale(-1),false)
                                // position=XYZ.newFrom(this.pointOfViewToPos[this.$pointOfVue.selectedIndex])
                                // this.sphereMathisFrameCamera.changePosition(position,false)
                                // this.sphereMathisFrameCamera.changeUpVector(new XYZ(0,1,0),false)
                                // this.sphereMathisFrameCamera.changeFrontDir(XYZ.newFrom(position).scale(-1),false)
            ...
            private firstClick(clickedPoint:XYZ):void{
                ...
                let color:Color3
                if(this.mode==0) color=new Color3(Math.random(),Math.random(),Math.random())
                else  color=new Color3(0,1,0)
            ...
            private secondClick(UVcenter:UV,UVclicked:UV,carte:Carte):void{
